...
export function RiskDistributionSummary({
  ...
  return (
    <section className="rounded-lg border border-border bg-white p-4 shadow-sm" aria-label="Risk distribution">
      ...
      <div className="mt-4">
        ...
        <div className="flex h-3 w-full rounded-full overflow-hidden bg-gray-100" role="img" aria-label="Stacked severity bar">
          {total === 0 ? (
